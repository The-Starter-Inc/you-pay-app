...
class FeedbackApiProvider {
  ...
  Future<List<Feedback>> fetchFeedbacks(String adsUserId) async {
    final response = await client.get(
        Uri.parse(
            "${AppConstant.host}/api/feedback?search=ads_user_id:equal:$adsUserId&sort=id&order=desc&rows=99999"),
        headers: headers);
